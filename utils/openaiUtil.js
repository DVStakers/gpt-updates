...
async function sendToOpenAI_3_5_Turbo(prompt) {
    const messages = []
...
async function sendToOpenAI_Manual(prompt) {
    const headers = {
...
module.exports = { sendToOpenAI, sendToOpenAI_3_5_Turbo, sendToOpenAI_Manual }
